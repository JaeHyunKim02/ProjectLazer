...
namespace eageramoeba.Lasers
{
    ...
    public class laserSystem : MonoBehaviour
    {
        ...
        void DoHitTagPrizm_Cube()//Collider PrizmCube
        {
            // if (PrizmCube.tag == ("Prizm_Cube"))
            //{
            //   Debug.Log("Prizm Cube입니다");
            //}
            if (rendS = hit2D[0].collider.gameObject.GetComponent<SpriteRenderer>())
            {
                tMat = new Material[rendS.sharedMaterials.Length];
                                ...
                                if (hit2D[0].collider)
                                {
                                    if (l1.hitReflMatMe && l1.hitReflectMe)
                                    {
                                        if (l1.hitScanModeMe == 1)
                                        {
                                            ...
                                            doHitM2D();//doHitM2D호출중 여기다가 넣어봅시다
                                            DoHitTagPrizm_Cube();
                                        ...
                                        else
                                        {
                                            ...
                                            doHitT(hit2D[0].collider.tag = ("Prizm_cube"));
